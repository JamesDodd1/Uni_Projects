...
namespace FrontEndSD
{
    ...
    class Staff : User
    {
        ...
        public Staff(int id, string accountNo, string username, string password, string firstName, string lastName, string email, string address, string postCode, DateTime dateOfBirth) : this()
        {
            this.id = id;
    ...
    class StaffFactory : UserFactory
    {
        ...
        /* Constructor */
        public StaffFactory(int id, string accountNo, string username, string password, string firstName, string lastName, string email, string address, string postCode, DateTime dateOfBirth)
        {
            this.id = id;
            this.accountNo = accountNo;
            this.username = username;
        ...
        {
            return new Staff(id, accountNo, username, password, firstName, lastName, email, address, postCode, dateOfBirth);
        }
    }
}
